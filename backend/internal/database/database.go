...
func Init() error {
	...
	if err := db.AutoMigrate(&model.User{}, &model.MLModel{}, &model.DataSource{}, &model.LogQueryHistory{}, &model.LogMonitor{}, &model.NotificationChannel{}, &model.AlertHistory{}); err != nil {
		return err
	}
